        ...
        <div className="legal-modal-body">
          ...
          <section className="legal-card" aria-labelledby="legal-title">
            ...
            <p className="legal-text">
              <br />
              서식의 내용은 사용자가 수정, 보완, 삭제할 수 있으며, 이러한 변경이 이루어진 경우를 포함하여 해당 서식의 내용에 대하여 서식 제공자 및 이폼사인은 법적 효력을 보증하지 않습니다.<br /><br />
              서식을 그대로 사용하거나, 수정·보완·삭제하여 사용함으로써 발생하는 분쟁 또는 손해(제3자와의 분쟁 및 손해를 포함)에 대하여 서식 제공자와 이폼사인은 법적 책임을 지지 않습니다.<br /><br />
